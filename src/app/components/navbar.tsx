...
const animals = [
  {
    name: "Dogs",
    description: "Loyal companions seeking forever homes",
    href: "/search?type=Dogs&page=1&location=&breed=Any",
    icon: FaDog,
  },
  {
    name: "Cats",
    description: "Independent charm, adoptable grace",
    href: "/search?type=Cats&page=1&location=&breed=Any",
    icon: FaCat,
  },
];
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                {session ? <button className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50" onClick={()=>logoutHandler()}>Log Out</button> : <Link
                  href="/account/login"
                  onClick={() => setMobileMenuOpen(false)}
